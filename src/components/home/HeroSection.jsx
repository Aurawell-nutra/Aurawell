...
// Staggered jar layout recreating the group shot from the reference design.
const jarStyles = [
  "z-10 w-[26%] translate-y-5",
  "z-20 -ml-[5%] w-[28%] translate-y-2",
  "z-30 -ml-[5%] w-[30%]",
  "z-20 -ml-[5%] w-[27%] translate-y-4",
];
