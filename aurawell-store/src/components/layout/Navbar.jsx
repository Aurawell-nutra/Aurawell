...
const iconButton =
  "inline-flex size-10 items-center justify-center rounded-full text-forest transition-colors hover:bg-sage";
    ...
    <>
      ...
      <header className="sticky top-0 z-40 border-b border-line/70 bg-cream/90 backdrop-blur-md">
        ...
        <div className="pointer-events-none absolute inset-0 isolate overflow-hidden" aria-hidden>
          <Botanical name="corner" className="bottom-0 left-0 hidden w-10 opacity-25 2xl:block" />
          <Botanical name="eucalyptus" className="top-0 right-0 hidden w-14 -scale-100 opacity-35 md:block" />
          <Botanical name="leafLight" className="-top-2 right-24 hidden w-6 rotate-[160deg] opacity-40 xl:block" />
        </div>
        <nav aria-label="Main" className="container-page relative flex h-18 items-center justify-between gap-4">
          <Logo />
