  ...
  return (
    <section id="newsletter" className="scroll-mt-24 bg-cream pb-16 sm:pb-20 lg:pb-24">
      <div className="container-page">
        <div className="relative isolate overflow-hidden rounded-[2rem] bg-forest px-6 py-12 text-white sm:px-10 lg:px-14 lg:py-14">
            ...
            <ul className="grid grid-cols-2 gap-4 sm:grid-cols-4">
              {trustBadges.map(({ icon: Icon, label }) => (
                <li key={label} className="flex flex-col items-center gap-3 text-center">
                  <span className="flex size-14 items-center justify-center rounded-full border border-white/30 bg-white/5">
